...
public class ConfirmInventory {
    public Inventory getMenu(Item item) {
        Inventory inventory = Bukkit.createInventory(new ConfirmMenu(), 45, String.format("%s%sConfirm", ChatColor.DARK_GRAY, ChatColor.BOLD));
        ...
        inventory.setItem(24, MenuItemFactory.CONFIRM_ITEM);
        inventory.setItem(25, MenuItemFactory.CONFIRM_ITEM);
