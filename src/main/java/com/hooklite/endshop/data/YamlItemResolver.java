...
public class YamlItemResolver extends YamlResolver {
    public static ItemConfig resolveValues(YamlConfiguration config, ItemConfig object) throws IllegalAccessException {
